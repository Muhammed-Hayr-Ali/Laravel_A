const registrShowPassword = document.getElementById('registrShowPassword');
const registrHidePassword = document.getElementById('registrHidePassword');
const registrPassword = document.getElementById('registrPassword');
const registrPasswordConfirmation = document.getElementById('registrPasswordConfirmation');



registrShowPassword.addEventListener("click", function (event) {
    event.preventDefault();
    registrShowPassword.style.display = "none";
    registrPassword.type = "text";
    registrPasswordConfirmation.type = "text";
    registrHidePassword.style.display = "block";
});

registrHidePassword.addEventListener("click", function (event) {
    event.preventDefault();
    registrHidePassword.style.display = "none";
    registrPassword.type = "password";
    registrPasswordConfirmation.type = "password";
    registrShowPassword.style.display = "block";
});
