  ...
  <nav class="flex main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <div>@include('partials/language_switcher')</div>
  </nav>
  {{--  
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="flex flex-row items-center text-xl">
...
<i class="fas fa-envelope"></i>
      ...
      <div class=" ml-4"> @include('partials/language_switcher')
      </div>
