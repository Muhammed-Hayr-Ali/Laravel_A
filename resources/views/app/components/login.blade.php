...
<div id="login">
    <div class="relative w-1/3 bg-white shadow-xl rounded-xl px-8 pt-6 pb-8 mb-4">
        <button id="closeLogin"><svg class="absolute top-1 right-1 h-4 w-4 fill-black hover:fill-red-500"  viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><path d="M195.2 195.2a64 64 0 0 1 90.496 0L512 421.504 738.304 195.2a64 64 0 0 1 90.496 90.496L602.496 512 828.8 738.304a64 64 0 0 1-90.496 90.496L512 602.496 285.696 828.8a64 64 0 0 1-90.496-90.496L421.504 512 195.2 285.696a64 64 0 0 1 0-90.496z"/></svg></button>
