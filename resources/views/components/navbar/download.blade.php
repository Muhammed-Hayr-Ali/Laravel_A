<div x-data="{ showBanner: false }" x-init="showBanner = false" class="relative">
    ...
    <button class="w-auto flex flex-row space-x-1 items-center" @mouseenter="showBanner = true"
        @mouseleave="showBanner = false">
        <svg width="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#FFFFFF">
            ...
            <g id="SVGRepo_iconCarrier">
                ...
                <path
                    ...
                    stroke="#FFFFFF" stroke-width="2" />
                <path d="M14 6.5H21" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M17.5 3V10" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </g>
        </svg>
        ...
        <div class="flex flex-col items-start text-white text-xs">
            ...
            <p class="font-light">the Marketna app</p>
        </div>
    ...
    <div @mouseenter="showBanner = true" @mouseleave="showBanner = false"
        class="absolute top-12 left-1/2 transform -translate-x-1/2 flex flex-auto" x-show="showBanner"
                ...
                <div class="flex flex-row space-x-3 ">
                    ...
                    <div class="flex flex-col ">
                        ...
                        <div class="flex flex-row items-center space-x-4">
                            ...
                            <svg class="w-8 h-8" viewBox="0 0 256 256" version="1.1"
