            ...
            <div class="table-top">
                <div class="search-set">
                    <div class="search-path">
                        ...
                        @if (isset($category_id) || isset($status_id) || isset($brand_id) || isset($other_variable))
                                ...
                                <select class="select" name="category">
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}"
                                            @if (request()->input('category') && $category_id == $category->id) selected @endif>
                                            {{ __($category->name) }}
                                        </option>
                                    @endforeach
                                </select>
                                        ...
                                        <div class="product-img">
                                            @if (isset($product->images()->first()->url))
                                                <a href="{{ asset($product->images()->first()->url) }}"
                                                    class="image-popup" data-lightbox="image-1"><img class="object-cover"
