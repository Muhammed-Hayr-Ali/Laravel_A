                        ...
                        @foreach ($levels as $level)
                            <tr data-id="{{ $level->id }}">
                                    ...
                                    <div class="productname">
                                        <div class="">
                                            @if (isset($level->image) && $level->image != null)
                                                <a href="{{ asset($level->image) }}" class="product-img image-popup"
                                ...
                                <td>
                                    ...
                                    <a class="mx-2" href="{{ route('Level.edit', ['Level' => $level->id]) }}"
                                    ...
                                    <a class="deleteButton" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        ...
                                        data-name="{{ __($level->name) }}" data-id="{{ $level->id }}">
