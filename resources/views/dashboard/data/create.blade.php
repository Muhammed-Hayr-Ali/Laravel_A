...
@section('title', trans('add_edit.Add ' . $name))
...
@section('content')
    ...
    <div class="page-header">
        <div class="page-title">
            <h4>{{ __('add_edit.Product Add ' . $name) }}</h4>
            <h6>{{ __('add_edit.Create new product ' . $name) }}</h6>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form id="form" action="{{ route('store', ['name' => $name]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
