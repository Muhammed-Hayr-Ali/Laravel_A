...
@section('title', trans('addStatus.Product Add Status'))
@section('Product', 'active')
@section('addStatus', 'active')
@section('head')
...
@section('content')
    ...
    <div class="page-header">
        <div class="page-title">
            <h4>{{ __('addStatus.Product Add Status') }}</h4>
            <h6>{{ __('addStatus.Create new product Status') }}</h6>
        </div>
    </div>


    <form id="form" action="{{ route('Status.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            <label>{{ __('addStatus.Status Name') }}</label>
                    ...
                    <div class="col-lg-12">
                        <button id="submit" type="submit"
                            class="btn btn-submit me-2 bg-[#ff9f43]">{{ __('addStatus.Submit') }}</button>
