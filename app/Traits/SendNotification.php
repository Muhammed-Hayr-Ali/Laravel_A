...
trait SendNotification
{
    function sendNotification($key, $value, $title, $message)
    {
        $heading = $title;
        $content = $message;
        $url = $url = 'https://onesignal.com/api/v1/notifications';
    ...
    function createUser($email, $id, $role)
    {
        $url = $url = 'https://api.onesignal.com/apps/49ef83b6-29de-457c-a160-de17abc8456c/users';
